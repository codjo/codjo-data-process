package net.codjo.dataprocess.gui;
...
public class DependencyTest extends PackageDependencyTestCase {
    public void test_dependency() throws Exception {
        ...
        dependency.addIgnoredPackage("net.codjo.dataprocess.gui.util.plugin");
        dependency.addIgnoredPackage("net.codjo.dataprocess.gui.plugin");
