 ...
 *
 */
public class DeleteDependencyCommand extends HandlerCommand {
    @Override
    public CommandResult executeQuery(CommandQuery query) throws HandlerException, SQLException {
        ...
        try {
            ...
            DependencyHandlerHelper.deleteDependency(con, repositoryId,
                                                     executionListIdPrinc, executionListIdDep);
