...
/**
 * Classe de test de {@link TreatmentFillStatusCommand}
 */
public class TreatmentFillStatusCommandTest extends HandlerCommandTestCase {
    @Override
    protected HandlerCommand createHandlerCommand() {
        return new TreatmentFillStatusCommand();
    }
