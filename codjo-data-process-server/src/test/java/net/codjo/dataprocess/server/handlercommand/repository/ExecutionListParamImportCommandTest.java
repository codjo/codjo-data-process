 ...
 *
 */
public class ExecutionListParamImportCommandTest extends HandlerCommandTestCase {
    @Override
    protected HandlerCommand createHandlerCommand() {
        return new ExecutionListParamImportCommand();
    }
    ...
    protected String getHandlerId() {
        return "executionListParamImport";
    }
}
